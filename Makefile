...
#am__append_1 = example-fuse
subdir = .
DIST_COMMON = $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/libganeshaNFS.pc.in \
	$(srcdir)/nfs-ganesha.spec.in $(top_srcdir)/configure \
	ChangeLog THANKS TODO build-aux/config.guess \
...
CONFIG_CLEAN_FILES = libganeshaNFS.pc nfs-ganesha.spec
...
ETAGS = etags
CTAGS = ctags
DIST_SUBDIRS = include Log BuddyMalloc Common ConfigParsing RW_Lock \
	SemN test LRU HashTable NodeList FSAL MFSL Cache_inode \
	File_Content File_Content_Policy XDR NFS_Protocols support \
	IdMapper snmp_adm MainNFSD cmdline_tools shell Docs tools \
	config_samples check debian rpm example-fuse
...
ACLOCAL = ${SHELL} /home/esamanas/nfs-ganesha-1.0.1/build-aux/missing --run aclocal-1.11
AMTAR = ${SHELL} /home/esamanas/nfs-ganesha-1.0.1/build-aux/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /home/esamanas/nfs-ganesha-1.0.1/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/esamanas/nfs-ganesha-1.0.1/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/esamanas/nfs-ganesha-1.0.1/build-aux/missing --run automake-1.11
AWK = mawk
...
EXT_LDADD = 
FGREP = /bin/grep -F
FSAL_CFLAGS = -I/usr/include/mysql
FSAL_LDFLAGS = -Wl,-Bsymbolic-functions -rdynamic -L/usr/lib/mysql -lmysqlclient_r
FSAL_LIB = $(top_builddir)/FSAL/FSAL_POSIX/libfsalposix.la $(top_builddir)/FSAL/FSAL_POSIX/DBExt/MYSQL/libfsaldbext.la
FS_NAME = posix
GREP = /bin/grep
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/esamanas/nfs-ganesha-1.0.1/build-aux/missing --run makeinfo
MFSL_LIB = 
MKDIR_P = /bin/mkdir -p
...
PACKAGE_STRING = nfs-ganesha 1.0.1
...
ZFSWRAP_CFLAGS = 
ZFSWRAP_LIBS = 
abs_builddir = /home/esamanas/nfs-ganesha-1.0.1
abs_srcdir = /home/esamanas/nfs-ganesha-1.0.1
abs_top_builddir = /home/esamanas/nfs-ganesha-1.0.1
abs_top_srcdir = /home/esamanas/nfs-ganesha-1.0.1
ac_configure_args =  '--with-fsal=POSIX' '--with-db=MYSQL'
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/esamanas/nfs-ganesha-1.0.1/build-aux/install-sh
...
SUBDIRS = include Log BuddyMalloc Common ConfigParsing RW_Lock SemN \
	test LRU HashTable NodeList FSAL MFSL Cache_inode File_Content \
	File_Content_Policy XDR NFS_Protocols support IdMapper \
	snmp_adm MainNFSD cmdline_tools shell cmdline_tools Docs tools \
	config_samples check debian rpm $(am__append_1)
...
$(am__aclocal_m4_deps):
libganeshaNFS.pc: $(top_builddir)/config.status $(srcdir)/libganeshaNFS.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
nfs-ganesha.spec: $(top_builddir)/config.status $(srcdir)/nfs-ganesha.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
